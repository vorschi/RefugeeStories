...
public class CustomGalleryActivity extends Activity {
    ...
    private void init() {
        ...
        if (action.equalsIgnoreCase(Consts.ACTION_MULTIPLE_PICK)) {

            findViewById(R.id.llBottomContainer).setVisibility(View.VISIBLE);
            gridGallery.setOnItemClickListener(mItemMulClickListener);
            adapter.setMultiplePick(true);

        } else if (action.equalsIgnoreCase(Consts.ACTION_PICK)) {
    ...
    View.OnClickListener mOkClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            List<CustomGalleryItem> selected = adapter.getSelected();
    ...
    AdapterView.OnItemClickListener mItemSingleClickListener = new AdapterView.OnItemClickListener() {
        ...
        @Override
        public void onItemClick(AdapterView<?> l, View v, int position, long id) {
            CustomGalleryItem item = adapter.getItem(position);
    ...
    private List<CustomGalleryItem> getGalleryPhotos() {
        List<CustomGalleryItem> galleryList = new ArrayList<>();
        ...
        try {
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (cursor.moveToNext()) {
                    ...
                    item.sdcardPath = cursor.getString(dataColumnIndex);
            ...
            Log.e(CustomGalleryActivity.class.getSimpleName(), e.getMessage());
        } finally {
            if(cursor != null)
                cursor.close();
        }
